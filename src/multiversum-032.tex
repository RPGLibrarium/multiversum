...
\subsection{Schwefeldraachen am Horizont!}
...
Wie auch in den letzten Jahren richtet der RPG Librarium Aachen e.V. die SchwefeldrAachen Con aus.
Am Wochenende 13./14. September gibt es einige Gelegenheit, Rollenspielrunden zu leiten und spielen.
Dazu gibt es wunderbare Aussteller mit erwerbbarem Angebot, tolle Workshops rund ums Thema und der Librarium bietet einen Einblick in die Büchersammlung.
Der Eintritt ist frei.

Mit eurer Hilfe gibt es auch wieder all die netten Menschen, mit denen man einfach mal eine Weile Quatschen kann.
Also kommt zahlreich in die Mefferdatisstraße 16-18, bleibt eine Stunde oder den ganzen Tag lang, und erfreut euch mit uns an Allem rund um das Thema Rollenspiel!
\verfasser{Redaktion}
